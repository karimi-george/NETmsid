...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['change_pswd'])) {
        ...
        if (empty($post_password) || empty($post_npassword) || empty($post_cnpassword)) {
            $msg_type = "error";
            $msg_content = "<b>fail:</b> Please fill in all inputs.";
        } else if ($verif_password == false) {
            $msg_type = "error";
            $msg_content = "<b>fail:</b> Password wrong.";
        } else if (strlen($post_npassword) < 5) {
            $msg_type = "error";
            $msg_content = "<b>fail:</b> The new password is too short, at least 5 characters.";
        } else if ($post_cnpassword <> $post_npassword) {
            $msg_type = "error";
            $msg_content = "<b>fail:</b> New password confirmation does not match.";
        } else if ($data_user['username'] == "demoadmin") {
            $msg_type = "error";
            $msg_content = "<b>fail:</b> Password cannot be changed .";
        } else {
            ...
            if ($update_user == TRUE) {
                $msg_type = "success";
                $msg_content = "<b>Success:</b> Password has been changed.";
            } else {
                $msg_type = "error";
                $msg_content = "<b>fail:</b> Error system.";
            }
        }
    }
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="site-title" class="form-control-label col-sm-3 ">past password</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="site-description" class="form-control-label col-sm-3 "> new
                                        Password</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label col-sm-3 ">konfirm new password</label>
                                    <div class="col-md-12">
                                        <input type="password" name="cnpassword" class="form-control"
                                            placeholder="konfirm new password">
                                    </div>
                                </div>
                            ...
                            <div class="card-footer bg-whitesmoke ">
                                <button class="btn btn-primary" name="change_pswd"><i class="fas fa-paper-plane"></i>
