    ...
    if (mysqli_num_rows($check_user) == 0) {
        ...
        if (isset($_POST['setting'])) {
            ...
            if (empty($post_title) || empty($post_logotext)) {
                $msg_type = "error";
                $msg_content = "<b>Gagal:</b> Please fill in all inputs.";
            } else {
                ...
                if ($update_status == TRUE) {
                    $msg_type = "success";
                    $msg_content = "<b>success:</b> Configuration was successful.";
                } else {
                    $msg_type = "error";
                    ...
                    <form class="form-horizontal" role="form" method="POST">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-danger"><i class="fas fa-globe"></i> Arrangement Website</h4>
                            </div>
                            <div class="card-body">
                                <?php
                                        if ($msg_type == "success") {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                        value="<?php echo $datadb_service['title']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Logo Text</label>
                                    <input type="text" class="form-control" name="logo_text"
                                        value="<?php echo $datadb_service['logo_text']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Logo Mini Text</label>
                                    <input type="text" class="form-control" name="text_mini"
                                        value="<?php echo $datadb_service['text_mini']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>language</label>
                                    <select class="form-control" name="langcode" required>
                                        <option value="<?php echo $datadb_service['lang']; ?>">
                                            <?php echo $datadb_service['lang']; ?></option>
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                        class="btn btn-primary btn-block waves-effect w-md waves-light"
                                        name="setting">submit</button>
                                </div>
