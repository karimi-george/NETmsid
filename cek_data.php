    ...
    if (isset($_POST['delbycomm'])) {
        ...
        if ($API->connect($iphost_mikrotik, $username_mikrotik, $password_mikrotik)) {
            ...
            for ($i = 0; $i < $all_data; $i++) {
                ...
                $msg_type = "success";
                $msg_content = "Delete Voucher by comment succeed";
            }
        } else {
            $msg_type = "error";
            $msg_content = "Router No Connect";
        }
    }
                            ...
                            <div class="card-body">
                                <center>
                                    ...
                                    <form class="form-horizontal" role="form" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-xs dim" name="delbycomm"><i class="fa fa-trash"></i> Delete all vouchers for that comment</button>
                                    </form>
                                </center>
