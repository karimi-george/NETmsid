                            ...
                            <div class="card-body">
                                ...
                                <script>
                                    function printV(a, b) {
                                        ...
                                        if (comm === "") {
                                            alert('Please choose one Comment first!');
                                        } else {
                                ...
                                <button class="btn btn-primary btn-xs dim" title='lihat data' onclick="lihat_data();"><i class="fa fa-list"></i> Check data by comment</button>
                                <br>
                                <br>
                                <hr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>Ksh<?php echo number_format($data_order['price'], 0, ',', '.'); ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
