    ...
    if (isset($_POST['generate'])) {
        ...
        for ($n = 1; $n <= $post_quantity; $n++) {
            ...
            if (empty($post_service)) {
                $msg_type = "error";
                $msg_content = "<b>fail:</b>Please fill in the input.";
            } else if (mysqli_num_rows($check_service) == 0) {
                $msg_type = "error";
                $msg_content = "<b>fail:</b> Service not found.";
            } else {
                $poid = $oid;

                if (empty($poid)) {
                    $msg_type = "error";
                    $msg_content = "<b>fail:</b> Server crash.";
                } else {
                    $API = new RouterosAPI();
                    $API->debug = false;
                    ...
                    if ($insert_order == TRUE) {
                        $msg_type = "success";
                        $msg_content = "<b>Succeed generate voucher.</b><br /><b>Service:</b> $service<br />";
                    } else {
                        $msg_type = "error";
                        $msg_content = "<b>Fail:</b> Error system (2).";
                    }
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                    <div class="alert alert-primary">
                                        ...
                                        <br>
                                        <a href="<?php echo $cfg_baseurl; ?>voucher/list"><label class="btn btn-success btn-xs dim" ; ?> Check Detail Voucher</label></a>
                                    </div>
                            </div>
                        <?php
                        ...
                        <form class="form-horizontal" role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="number" name="quantity" class="form-control" placeholder="Enter the amount you want to make">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">The length of each voucher</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="comment" class="form-control" placeholder="Enter Comments">
                                </div>
                            </div>
