...
if (isset($_POST['login'])) {
    ...
    if (empty($post_username)) {
        $msg_type = "error";
        $msg_content = '<b>fail:</b> please fill in all inputs..<script>swal("Error!", "fill in all inputs..", "error");</script>';
    } else if ($cek_pengguna_ulang == 0) {
        $msg_type = "error";
        $msg_content = '<b>fail:</b> Username not registered.<script>swal("Error!", "Username not registered.", "error");</script>';
    }
    if (empty($post_password)) {
        ...
        $msg_type = "error";
        $msg_content = '<b>fail:</b>  Wrong Password .<script>swal("Error!", " Wrong Password.", "error");</script>';
    } else {
        ...
        if ($cek_pengguna_ulang == 1) {
            if ($verif_password == true) {
                ...
                $msg_type = "error";
                $msg_content = "<b>fail:</b> Error system (1).";
            }
        }
    }
}
                ...
                <div class="row">
                    <div
                        ...
                        <div class=" card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-lg btn-block" name="login" type="submit"><i
                        ...
                        <div class="simple-footer">
                            Copyright &copy; developed by NETBRIDGE😃😇 <?php echo date("Y"); ?>
                        </div>
                    </div>
                </div>
            </div>
